let handler = async (m, { conn, text }) => {
  ...
  conn.reply(m.chat, `Kamu sudah mengikhlaskan Pasti suatu saat ketemu yang lebih baik lagi @${global.db.data.users[m.sender].pasangan.split('@')[0]} karena dia tidak memberikan jawaban diterima atau ditolak`, m, {contextInfo: {
    mentionedJid: [global.db.data.users[m.sender].pasangan]
  }})
